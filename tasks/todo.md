...
- [ ] Step 5: `repositories/conquestsRepo.ts` — fetch climbs w/ checkpoints (cached), upsert conquest (keep best), list user's conquests
- [ ] Step 6: hook detection into ride-save flow + "VZPON OSVOJEN" celebration modal
- [ ] Step 7: gold conquest ShareCard variant → StoryShareSheet → Instagram
- [ ] Step 8: "Kralj vzponov" collection screen (progress header, conquered colored w/ time, locked greyed) + progress strip on home Vzponi banner
### Phase 2 — Profil tab
